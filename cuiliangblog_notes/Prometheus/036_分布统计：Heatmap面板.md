...
> 来源: Prometheus
> 创建时间: 2020-12-12T18:25:09+08:00
> 更新时间: 2026-01-11T09:31:00.611494+08:00
> 阅读量: 908 | 点赞: 0
...
![](https://via.placeholder.com/800x600?text=Image+ff1cc8445009f217)
...
![](https://via.placeholder.com/800x600?text=Image+4f72384bd7cc2b2e)

通过以上设置，即可实现对Histogram类型监控指标的可视化。

![](https://via.placeholder.com/800x600?text=Image+89344112e1579ebf)

# 二、使用Heatmap可视化其它类型样本分布情况
1. 对于非Histogram类型，由于其监控样本中并不包含Bucket相关信息，因此在Metrics选项中需要定义Format      as为Time series，如下所示：

![](https://via.placeholder.com/800x600?text=Image+fe55683e994fd441)

1. 并且通过Axes选项中选择Data      format方式为Time series。设置该选项后Heatmap Panel会要求用户提供Bucket分布范围的设置，如下所示：

![](https://via.placeholder.com/800x600?text=Image+1ac71b69c655dd1b)
...
![](https://via.placeholder.com/800x600?text=Image+a76b52d66a9f692e)
