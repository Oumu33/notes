...
> 来源: Prometheus
> 创建时间: 2023-07-08T08:48:07+08:00
> 更新时间: 2026-01-11T09:31:20.225907+08:00
> 阅读量: 1192 | 点赞: 0
...
</font><font style="color:rgb(48, 49, 51);">Alertmanager负责接收并处理来自Prometheus Server的告警信息。对这些告警信息进行进一步的处理，比如当接收到大量重复告警时能够消除重复的告警信息，同时对告警信息进行分组并且路由到正确的通知方，Prometheus内置了对邮件、Slack、webhook等多种通知方式的支持，同时AlertManager还提供了静默和告警抑制机制来对告警通知行为进行优化。</font>![](https://via.placeholder.com/800x600?text=Image+bd5eaae8bf9bb18f)
...
![](https://via.placeholder.com/800x600?text=Image+71e706a4f9fd79d9)<font style="color:rgb(48, 49, 51);">  
</font>![](https://via.placeholder.com/800x600?text=Image+0e08d73c2540fe1b)

+ <font style="color:rgb(48, 49, 51);">访问prometheus的/status，查看Alertmanager信息</font>

![](https://via.placeholder.com/800x600?text=Image+1e1dba2cae2b9f6e)
...
![](https://via.placeholder.com/800x600?text=Image+1ea8bd6f0fcdaae8)
...
![](https://via.placeholder.com/800x600?text=Image+a6676c3c0fecb819)

+ <font style="color:rgb(48, 49, 51);">接下来关闭集群中一个节点，模拟宕机故障</font>

![](https://via.placeholder.com/800x600?text=Image+62c7445a115ecb08)

+ <font style="color:rgb(48, 49, 51);">此时已处于 PENDING 状态，因为上面设置了for：5m，需要down的状态持续5分钟，才会发出告警通知</font>

![](https://via.placeholder.com/800x600?text=Image+bcdc0e588290d744)

+ <font style="color:rgb(48, 49, 51);">此时在Alertmanager中就可以看到详细的告警信息</font>

![](https://via.placeholder.com/800x600?text=Image+36c1fdf536881edc)

+ <font style="color:rgb(48, 49, 51);">除了在Alertmanager中查看告警信息，Prometheus也会将它们存储到时间序列ALERTS{}中。</font>

![](https://via.placeholder.com/800x600?text=Image+768ef140d52dae41)<font style="color:rgb(48, 49, 51);"></font>
