...
> 更新时间: 2026-01-11T08:58:51.687728+08:00
> 阅读量: 1346 | 点赞: 0
...
## 项目流程图
![](https://via.placeholder.com/800x600?text=Image+398975ebe8e336f0)
...
![](https://via.placeholder.com/800x600?text=Image+8106301fdf3b29a6)
...
![](https://via.placeholder.com/800x600?text=Image+b603c36dacdd1936)

创建repo，具体可参考文档：[ArgoCD快速体验-崔亮的博客 (cuiliangblog.cn)](https://www.cuiliangblog.cn/detail/section/119675638)，repo配置如下：

![](https://via.placeholder.com/800x600?text=Image+ac2a1a7bc02be302)
...
![](https://via.placeholder.com/800x600?text=Image+27ac6cdd040cd3e4)
...
![](https://via.placeholder.com/800x600?text=Image+9258b73b05dbe270)

查看kustomization.yaml文件，已替换并提交最新的镜像地址。

![](https://via.placeholder.com/800x600?text=Image+ab3ea88b1921d8dd)

同样的操作，对test分支配置ci流水线，查看test分支kustomization.yaml文件信息

![](https://via.placeholder.com/800x600?text=Image+b0c297e531d60985)
...
![](https://via.placeholder.com/800x600?text=Image+1bffd0271b46d306)
...
![](https://via.placeholder.com/800x600?text=Image+27caa5e8dd38901c)
...
![](https://via.placeholder.com/800x600?text=Image+4be5548ad4ce18fa)

查看仓库rollout.yaml文件，已经替换为最新的镜像地址。

![](https://via.placeholder.com/800x600?text=Image+1cd4d8965acadf9d)
...
![](https://via.placeholder.com/800x600?text=Image+5aa4cc053529c5c9)
...
![](https://via.placeholder.com/800x600?text=Image+8a2f8ee42aa8cde8)
...
![](https://via.placeholder.com/800x600?text=Image+9cb0747c7f0156e8)
...
![](https://via.placeholder.com/800x600?text=Image+08daeec476cbe537)
...
</font>![](https://via.placeholder.com/800x600?text=Image+172c2b8443aee7e4)

## <font style="color:rgb(48, 49, 51);">更新Project</font>
<font style="color:rgb(48, 49, 51);">更新devops项目权限配置，允许对k8s-test集群进行操作。</font>

![](https://via.placeholder.com/800x600?text=Image+88ed755f1ed943af)
...
![](https://via.placeholder.com/800x600?text=Image+754b519030c667aa)<font style="color:rgb(48, 49, 51);">  
