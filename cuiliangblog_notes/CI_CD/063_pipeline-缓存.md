...
> 更新时间: 2026-01-12T14:24:48.935178+08:00
> 阅读量: 630 | 点赞: 0
...
![](https://cdn.nlark.com/yuque/0/2024/png/2308212/1716471041769-6e1992c5-b8e3-452e-8f31-1e97a5d43017.png)
...
![](https://cdn.nlark.com/yuque/0/2024/png/2308212/1716390518388-01889a68-ff30-4789-9d8a-b2693ab7ea80.png)

开始第二个作业test，此时会把当前目录中的target目录删除掉（因为做了git 对比）。然后获取到第一个作业生成的缓存target目录。

![](https://cdn.nlark.com/yuque/0/2024/png/2308212/1716390580993-63459d05-f77c-4d48-8473-867994e11281.png)

开始第三个作业，同样先删除了target目录，然后获取了第二个作业的缓存。最后生成了当前的缓存。

![](https://cdn.nlark.com/yuque/0/2024/png/2308212/1716391119442-10639449-e2f0-4be6-86ec-70ace4b006da.png)

当我们再次重新运行流水线时，查看build日志发现，使用的是上一次流水线的缓存。

![](https://cdn.nlark.com/yuque/0/2024/png/2308212/1716392125582-ce7afb3d-3a6f-48d3-9796-622a23e627a3.png)
...
![](https://cdn.nlark.com/yuque/0/2024/png/2308212/1716392026540-75222afd-5ed4-4ebf-acfa-b41052bb6cd2.png)
