...
> 更新时间: 2026-01-11T08:57:53.049934+08:00
> 阅读量: 977 | 点赞: 0
...
![](https://via.placeholder.com/800x600?text=Image+058c419211e3d262)

2. 更新部署： 应用程序的更新版本部署到绿色环境，该环境在基础设施、配置和数据方面镜像蓝色环境。绿色环境最初与用户流量保持隔离。

![](https://via.placeholder.com/800x600?text=Image+b5c33c73671dfd61)
...
![](https://via.placeholder.com/800x600?text=Image+ff0b0c06783fbd0a)

5. 监控和验证： 在整个部署过程中，蓝色和绿色环境都会受到监控，以检测任何问题或异常情况。监控工具和可观察性实践有助于实时识别性能问题、错误或不一致。验证无误后可删除老版本资源。

![](https://via.placeholder.com/800x600?text=Image+5c0a6f3028bb7109)
...
![](https://via.placeholder.com/800x600?text=Image+c01cfe623fbc8a51)
...
![](https://via.placeholder.com/800x600?text=Image+fdad0beedfe96ae8)
...
![](https://via.placeholder.com/800x600?text=Image+0470a3a6ebcdbedd)

![](https://via.placeholder.com/800x600?text=Image+6a115e4049587c37)
...
![](https://via.placeholder.com/800x600?text=Image+d60ac6b105a3e304)

![](https://via.placeholder.com/800x600?text=Image+f19f94f3f841d1ed)
...
![](https://via.placeholder.com/800x600?text=Image+09af4297eb7f5fb8)

![](https://via.placeholder.com/800x600?text=Image+d5b7bab005ff8ffb)

此时查看dashboard页面，内容如下

![](https://via.placeholder.com/800x600?text=Image+f5f2c3128be70ece)
...
![](https://via.placeholder.com/800x600?text=Image+a312ebdba668d5db)
...
## ArgoCD dashboard
![](https://via.placeholder.com/800x600?text=Image+6db792afcb246daf)
...
![](https://via.placeholder.com/800x600?text=Image+7ea3f7950070ae31)
...
![](https://via.placeholder.com/800x600?text=Image+42934a85b182077c)

访问测试环境，已经无法提供服务。

![](https://via.placeholder.com/800x600?text=Image+582e486fc5ceb8ea)
