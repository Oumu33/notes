...
> 来源: ELK Stack
> 创建时间: 2024-03-16T17:42:44+08:00
> 更新时间: 2026-01-11T09:26:36.811788+08:00
> 阅读量: 973 | 点赞: 0
...
![](https://via.placeholder.com/800x600?text=Image+96d2e4e1f9d3e098)

填写位置为/mnt/es-backup，其他保持默认即可

![](https://via.placeholder.com/800x600?text=Image+22c68f4856f02595)

注册完成后点击验证存储库，显示已连接

![](https://via.placeholder.com/800x600?text=Image+d8ac106c0ae1bebb)
...
![](https://via.placeholder.com/800x600?text=Image+50653060e280c9a8)
...
备份策略创建后，界面如下所示![](https://via.placeholder.com/800x600?text=Image+aa3350aa274c14ce)

## 数据备份
创建完策略后，es会在每天8点自动将数据上传至nfs备份，我们也可以点击立即执行，手动触发一次备份任务操作。![](https://via.placeholder.com/800x600?text=Image+c93023643ddf6902)

点击立即执行后，查看快照信息，显示已备份完成。

![](https://via.placeholder.com/800x600?text=Image+8c9f3aa7fbe54c58)
...
![](https://via.placeholder.com/800x600?text=Image+fb380d1b8683cefe)
