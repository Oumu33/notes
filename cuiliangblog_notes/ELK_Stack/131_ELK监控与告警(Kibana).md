...
> 来源: ELK Stack
> 创建时间: 2024-03-20T23:05:40+08:00
> 更新时间: 2026-01-11T09:28:22.529056+08:00
> 阅读量: 873 | 点赞: 0
...
![](https://via.placeholder.com/800x600?text=Image+ac657ab368accd07)
...
![](https://via.placeholder.com/800x600?text=Image+da6ce2d7a947b7fa)

我们点击beats链接即可跳转至filebeat指标详情页面。

![](https://via.placeholder.com/800x600?text=Image+08a8c4145546fc03)
...
![](https://via.placeholder.com/800x600?text=Image+0a7de07f3a2090d4)



如果指定了Logstash日志路径，在此修改路径。代理策略选择agent policy即可。

![](https://via.placeholder.com/800x600?text=Image+2d47f48d71de98ea)

## 访问验证
添加完成后，等待3-5分钟，访问kibana的monitor页面即可看到已新增Logstash信息。

![](https://via.placeholder.com/800x600?text=Image+eda65680d66ad946)

点击overview即可查看Logstash指标信息

![](https://via.placeholder.com/800x600?text=Image+af442bb6073c0ec7)
...
![](https://via.placeholder.com/800x600?text=Image+e82a14d95cc3e01b)
...
![](https://via.placeholder.com/800x600?text=Image+2767fae46c56cbc0)
...
![](https://via.placeholder.com/800x600?text=Image+24ba79c94f78d905)

点击测试查询，显示已匹配13个文档，说明告警规则配置无误

![](https://via.placeholder.com/800x600?text=Image+b09003e4a8cf2462)

## 创建连接器
连接器，也就是告警媒介，告警通过什么方式发送出来，由于使用的社区免费版，所以暂时只开放了服务器日志和索引两个选项。如果想要使用其他告警媒介，需要购买授权才可以。接下来以索引为例，将告警信息写入指定的索引中。

![](https://via.placeholder.com/800x600?text=Image+6d839b9b22ec4f64)

在索引文档中填写入的告警信息字段，通过右侧的变量菜单可以浏览引用相关的变量。

![](https://via.placeholder.com/800x600?text=Image+37815ab14d6f10d9)

点击保存后，告警规则添加完毕

![](https://via.placeholder.com/800x600?text=Image+a9cfbc7075481a71)

## ES集群监控告警
kibana除了可以监控指定查询语句是否满足告警条件外，还支持ES集群状态监控以及节点状态监控，我们只需要按实际需求选择对于的告警规则即可。

![](https://via.placeholder.com/800x600?text=Image+1139e186d42356db)

## 查看告警记录
在索引管理中，已经可以看到自动创建了名为alert-index的索引，有1条告警记录信息。

![](https://via.placeholder.com/800x600?text=Image+a9b8931dac4fbada)

接下来创建数据视图，方便后续查看告警记录信息。

![](https://via.placeholder.com/800x600?text=Image+f9882c867c4c7952)

在discover中可以看到告警产生的时间和告警值信息。

![](https://via.placeholder.com/800x600?text=Image+4b194a2d85ce8ba4)
