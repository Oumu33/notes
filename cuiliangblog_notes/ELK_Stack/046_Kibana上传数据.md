...
![](https://via.placeholder.com/800x600?text=Image+1177ecd6ff8714ac)
...
![](https://via.placeholder.com/800x600?text=Image+fb158456c0b99268)

+ 导入数据

![](https://via.placeholder.com/800x600?text=Image+1758c6a1d8d64cda)

### 步骤3：导入成功
![](https://via.placeholder.com/800x600?text=Image+adba3b1b8bf4c93e)

## 3.2 Select an index pattern 选择一个索引pattern
就简单列一下，如何操作。

![](https://via.placeholder.com/800x600?text=Image+13f09d8e89e51e3f)

![](https://via.placeholder.com/800x600?text=Image+51a9357e0265bb1c)
