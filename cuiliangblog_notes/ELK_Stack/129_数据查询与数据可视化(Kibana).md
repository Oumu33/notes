...
> 来源: ELK Stack
> 创建时间: 2024-03-20T23:06:11+08:00
> 更新时间: 2026-01-11T09:27:54.044845+08:00
> 阅读量: 560 | 点赞: 1
...
![](https://via.placeholder.com/800x600?text=Image+7b14576b8327e299)
...
![](https://via.placeholder.com/800x600?text=Image+9bbe9f3644ea4d97)

## 显示指定字段信息
默认显示文档的所有字段信息，我们可以通过左侧的字段选择框，过滤出需要查看的字段信息，结果会以表格的形式展示。

![](https://via.placeholder.com/800x600?text=Image+192d985d423522bf)
...
![](https://via.placeholder.com/800x600?text=Image+df2da5a1fe5f3467)

方式二：添加筛选条件

![](https://via.placeholder.com/800x600?text=Image+6dbfb2fa0065841f)

或者直接使用KQL语法筛选数据

![](https://via.placeholder.com/800x600?text=Image+d6f039ecdf925a28)

查询结果如下所示：

![](https://via.placeholder.com/800x600?text=Image+65efda5839390ead)

## 查询汇总数据
除了查询数据外，discover也支持简单的数据聚合汇总，例如我们可以查看level字段值的种类和每个值的个数信息。

![](https://via.placeholder.com/800x600?text=Image+793a6b11d288dedd)

## 结果导出
点击右上方的共享按钮，即可导出CSV格式报告。

![](https://via.placeholder.com/800x600?text=Image+f84f29e065747b27)
...
![](https://via.placeholder.com/800x600?text=Image+9da2036c020b9168)

点击添加筛选后，查询结果如下所示：

![](https://via.placeholder.com/800x600?text=Image+c815632847983994)
...
![](https://via.placeholder.com/800x600?text=Image+2f7ffdf3479889fa)

## 添加实时日志显示
接下来在stream菜单中，点击设置按钮，选择刚刚修改好的myapp数据视图。

![](https://via.placeholder.com/800x600?text=Image+a39af05eec97d44a)

修改名称和数据视图，日志源选择myapp

![](https://via.placeholder.com/800x600?text=Image+5d42b6889c969a43)

## 查看效果
接下来就会在页面中实时滚动输出最新的日志信息。

![](https://via.placeholder.com/800x600?text=Image+416b0b9fbae7b8e3)

往往我们更关注日志等级为error的日志，我们只需要添加筛选条件即可。

![](https://via.placeholder.com/800x600?text=Image+6c9ef505e4611974)
...
![](https://via.placeholder.com/800x600?text=Image+d251e808463b6341)

## 单值图
以应用访问量为例，我们只需要查询指定时间范围内的count即可，图标配置如下所示

![](https://via.placeholder.com/800x600?text=Image+0d7a573e569899e8)
...
![](https://via.placeholder.com/800x600?text=Image+66143e9e862658a2)

垂直轴我们指定request_time字段的平均值。

![](https://via.placeholder.com/800x600?text=Image+26e5410e0dd7fbbe)

另一个垂直轴我们选择count数

![](https://via.placeholder.com/800x600?text=Image+faf3fe0abd47a3c1)

## 柱状图
以分析返回状态码数据，水平轴选取access_status字段值的前5

![](https://via.placeholder.com/800x600?text=Image+5eb0b84e9d2a8c8c)

垂直轴使用count计数

![](https://via.placeholder.com/800x600?text=Image+4e79b1a066e1be8c)

## 饼图
以分析用户请求方式为例，选择饼图，字段选择request_method即可。

![](https://via.placeholder.com/800x600?text=Image+b4b9eea578e17044)

## 效果演示
制作完成的dashboard如下所示

![](https://via.placeholder.com/800x600?text=Image+c4731f4a3e9e3bbd)
...
![](https://via.placeholder.com/800x600?text=Image+5ef6bab8276b3870)

## 创建热力图
依次点击菜单Analytics——>Maps，创建地图。

![](https://via.placeholder.com/800x600?text=Image+1784784e07b3771b)

进入后，已经为我们默认提供了一张世界地图，接下来我们添加一个热图图层即可。

![](https://via.placeholder.com/800x600?text=Image+18d0feb7999e6539)

数据视图选择myapp，kibana会自动扫描该数据视图下geo_point类型的字段。

![](https://via.placeholder.com/800x600?text=Image+214c4dd415d64d3e)

点击添加即可，一张热力图便制作完成。

![](https://via.placeholder.com/800x600?text=Image+d8584f9a78be1b22)

可能某些应用主要针对国内用户访问，而默认提供的世界地图对国内信息显示不够详细，此时我们可以添加自定义图层。

![](https://via.placeholder.com/800x600?text=Image+5f30100cc820231f)
...
![](https://via.placeholder.com/800x600?text=Image+58aa7ac4220a2f3d)
