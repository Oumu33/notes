...
![](https://via.placeholder.com/800x600?text=Image+8609797c0fa5d0fc)
...
![](https://via.placeholder.com/800x600?text=Image+d3f0a79d65e76dc7)

如下所示，我们需要采集myapp和springboot两个应用的日志，只需要添加多条Custom logs集成策略即可。

![](https://via.placeholder.com/800x600?text=Image+e3e66355d864a7fb)
