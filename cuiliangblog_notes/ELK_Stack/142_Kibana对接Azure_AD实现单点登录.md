...
> 来源: ELK Stack
> 创建时间: 2024-03-20T23:02:51+08:00
> 更新时间: 2026-01-11T09:29:10.295804+08:00
> 阅读量: 404 | 点赞: 1
...
![](https://via.placeholder.com/800x600?text=Image+9d5b230b6b541751)
...
![](https://via.placeholder.com/800x600?text=Image+6707a5aefc06be32)
...
![](https://via.placeholder.com/800x600?text=Image+27cd4aae75559e1a)

我们可以在kibana页面选择试用白金版本功能，升级我们的license授权。

![](https://via.placeholder.com/800x600?text=Image+fc1e9104b4b7d005)
...
![](https://via.placeholder.com/800x600?text=Image+0383c971b367d7b3)

+ 组信息

![](https://via.placeholder.com/800x600?text=Image+2f9727cf88b680a3)

## 创建企业应用程序
Microsoft Entra ID——>企业应用程序——>新建应用程序

![](https://via.placeholder.com/800x600?text=Image+60ac83b6bee22a21)

创建你自己的应用程序——>输入应用名称——>选择集成未在库中找到的任何其他应用程序(非库)

![](https://via.placeholder.com/800x600?text=Image+1d4483d35482b8c0)

## 分配用户和组
配置哪些用户和组可以登录访问kibana应用。

![](https://via.placeholder.com/800x600?text=Image+66fa54d1595f6f5a)

## 配置单点登录
单一登录——>选择SAML方式登录

![](https://via.placeholder.com/800x600?text=Image+dc25d9d2d0d6d4e0)
...
![](https://via.placeholder.com/800x600?text=Image+5db86dda39621557)

## 配置属性
默认属性中并未携带组信息，我们可以添加组声明属性，通过Azure登录后会将用户组信息传给Kibana。

![](https://via.placeholder.com/800x600?text=Image+ff5e0185e7bcf783)

添加后页面显示内容如下

![](https://via.placeholder.com/800x600?text=Image+737debd1dd7ea95b)

## 下载SAML文件
配置完后后点击下载联合元数据XML，并导入elasticsearch服务器目录中。

![](https://via.placeholder.com/800x600?text=Image+54de602a087fbdb1)
...
![](https://via.placeholder.com/800x600?text=Image+93278f46f20efdc2)
...
![](https://via.placeholder.com/800x600?text=Image+64fd5e1f30c307d6)

创建ops角色，给运维人员使用，拥有kibana的全部权限。

![](https://via.placeholder.com/800x600?text=Image+fcb11729aed699c8)

## 查看Azure AD组ID
接下来查看Azure AD组的ID编号并记录，用于将其与kibana的dev和ops角色关联。

![](https://via.placeholder.com/800x600?text=Image+e418b121c9c8ec32)
...
![](https://via.placeholder.com/800x600?text=Image+dccbdf8dc8474e61)

+ 创建ops角色映射

![](https://via.placeholder.com/800x600?text=Image+9dba8132dcddccd8)

## 访问验证
+ dev用户登录，使用Azure AD方式登录kiban，用户名为dev@cuiliang.onmicrosoft.com，登录kibana后信息和权限如下：

![](https://via.placeholder.com/800x600?text=Image+54ff478a6e0b619b)

+ 同样的使用ops用户登录，信息如下

![](https://via.placeholder.com/800x600?text=Image+f5e25d93b2814852)
...
![](https://via.placeholder.com/800x600?text=Image+b4cead80006a7cfa)
