...
> 来源: ELK Stack
> 创建时间: 2024-03-20T23:06:40+08:00
> 更新时间: 2026-01-11T09:27:42.523092+08:00
> 阅读量: 635 | 点赞: 0
...
![](https://via.placeholder.com/800x600?text=Image+0a47bc97c4835c37)
...
![](https://via.placeholder.com/800x600?text=Image+0e445edea0b1b97d)
...
![](https://via.placeholder.com/800x600?text=Image+a08bb72f9c8dffda)

kibana登录成功

![](https://via.placeholder.com/800x600?text=Image+111f8bd45acdf904)
...
![](https://via.placeholder.com/800x600?text=Image+2458713f2aac2a6c)
...
## 获取es集群uuid
![](https://via.placeholder.com/800x600?text=Image+eb9875d53e8e7aa1)
...
![](https://via.placeholder.com/800x600?text=Image+5da45aec601685bb)
...
![](https://via.placeholder.com/800x600?text=Image+d19f8755a1991049)

## 添加elasticsearch采集监控
进入Kibana集成菜单，搜索Elasticsearch并安装。

![](https://via.placeholder.com/800x600?text=Image+3b2f65b904d17917)

填写集成策略名称和描述，选择已有的Fleet Server Policy

![](https://via.placeholder.com/800x600?text=Image+d2319e0c8a3b23a0)

在metrics配置中，填写es的地址和账号密码，并指定ca证书路径。logs配置无需更改，使用默认配置即可。

![](https://via.placeholder.com/800x600?text=Image+cef4e69e5b144595)

## 添加logstash采集监控
<font style="color:rgb(48, 49, 51);">配置代理策略，先添加Logstash集成。  
</font>![](https://via.placeholder.com/800x600?text=Image+63a44bce3c72f400)

<font style="color:rgb(48, 49, 51);">metrics填写http://logstash:9600，代理策略选择Fleet Server Policy即可。  
</font>![](https://via.placeholder.com/800x600?text=Image+fce186a8669a33bf)

# 访问验证
## 查看monitor信息
![](https://via.placeholder.com/800x600?text=Image+37b25f9056563bc9)

## 查看数据流信息
在kibana的索引管理中，查看数据流信息，已成功创建数据流，并向其中持续写入数据。

![](https://via.placeholder.com/800x600?text=Image+15a267d76749058d)

## 查看字段信息
在discover中可以看到写入es的数据，已经是logstash处理过的数据内容。![](https://via.placeholder.com/800x600?text=Image+a82d453cb00320de)
