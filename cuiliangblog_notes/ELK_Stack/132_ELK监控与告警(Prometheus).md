...
> 来源: ELK Stack
> 创建时间: 2024-03-20T23:05:27+08:00
> 更新时间: 2026-01-11T09:28:26.477315+08:00
> 阅读量: 1026 | 点赞: 2
...
# 整体思路
## 监控架构图
![](https://via.placeholder.com/800x600?text=Image+92affb7a8cc3becd)
...
![](https://via.placeholder.com/800x600?text=Image+37bc8483ff7bfa85)
...
![](https://via.placeholder.com/800x600?text=Image+f9c13715f0864638)
...
![](https://via.placeholder.com/800x600?text=Image+1d7d4b8275dda64b)

添加Elasticsearch数据源

![](https://via.placeholder.com/800x600?text=Image+51e234a74788065c)

填写Elasticsearch配置信息

![](https://via.placeholder.com/800x600?text=Image+65f5d435dd5e7e95)

设置Alertmanager为默认告警媒介

![](https://via.placeholder.com/800x600?text=Image+5eb33ceced52b595)

点击右侧test按钮，发送测试告警信息，在alertmanager中查看。

![](https://via.placeholder.com/800x600?text=Image+419fe56c91f90399)
...
## Node
![](https://via.placeholder.com/800x600?text=Image+6159ab56dc8c70f1)

![](https://via.placeholder.com/800x600?text=Image+674d5b62e8ba600b)

## Kafka
![](https://via.placeholder.com/800x600?text=Image+15cd5662865a3a07)

## Logstash
![](https://via.placeholder.com/800x600?text=Image+6f7a185baba98081)

## Elasticsearch
![](https://via.placeholder.com/800x600?text=Image+418733d787ad6871)
...
![](https://via.placeholder.com/800x600?text=Image+c4e145669e04e396)

点击create alert rule创建告警规则。

## 告警规则配置
### 设置告警名称
![](https://via.placeholder.com/800x600?text=Image+3694439a474e09b7)

### 设置告警条件
![](https://via.placeholder.com/800x600?text=Image+7dc5a0917d3244b1)
...
### 设置告警评估
![](https://via.placeholder.com/800x600?text=Image+34e368838cef8d61)

### 设置告警内容
![](https://via.placeholder.com/800x600?text=Image+20b0f1af0114828e)

### 添加告警标签
![](https://via.placeholder.com/800x600?text=Image+526e2a7beb5340ae)

通常情况下会为每条告警添加告警组、告警等级标签。方便alertmanager根据不同的告警组和标签，通过不同的告警媒介实现告警分组分级通知。

## 查看Alertmanager记录
![](https://via.placeholder.com/800x600?text=Image+7bc999ef183ef9ae)
...
![](https://via.placeholder.com/800x600?text=Image+a06f52c3bc679cd2)
...
## 查看Alertmanager记录
![](https://via.placeholder.com/800x600?text=Image+b18b81d4898a7ed3)
