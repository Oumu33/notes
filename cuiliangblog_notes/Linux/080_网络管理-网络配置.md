...
> 来源: Linux
> 创建时间: 2021-02-16T09:42:24+08:00
> 更新时间: 2026-01-11T09:33:55.751842+08:00
> 阅读量: 768 | 点赞: 0
...
![](https://via.placeholder.com/800x600?text=Image+81e7dff1e60552fa)
...
![](https://via.placeholder.com/800x600?text=Image+bed913f52240c62c)

 

![](https://via.placeholder.com/800x600?text=Image+3f7cc4c99d0fe020)

 

![](https://via.placeholder.com/800x600?text=Image+6aaa97af20b19cc9)

1. 修改网卡配置文件

![](https://via.placeholder.com/800x600?text=Image+e2f6614562a3a1aa)
...
![](https://via.placeholder.com/800x600?text=Image+f2a2e47e50a7f455)

      ethx：查看某个以太网卡配置信息

![](https://via.placeholder.com/800x600?text=Image+33186711f191e996)

      ifconfig ethx IP/MASK    例如：ifconfig eth0 192.168.1.100/24   给ethx这个网络接口配置静态IP地址

![](https://via.placeholder.com/800x600?text=Image+4dbc8ab88c07d1bc)

      ifconfig ethx:x IP/MASK up   给网卡配置多个IP地址并生效

![](https://via.placeholder.com/800x600?text=Image+be687fda34eebb70)

      Ifconfig ethx:x del IP     删除IP地址   例如：

![](https://via.placeholder.com/800x600?text=Image+5212a0dd57e04174)
...
![](https://via.placeholder.com/800x600?text=Image+cc0b0685a3341f9e)
...
![](https://via.placeholder.com/800x600?text=Image+7096eac78ee51095)

addr：show [[dev] interface]  label可以指定别名

![](https://via.placeholder.com/800x600?text=Image+96cf065614a4757d)

 

      add IP/MASK dev interface 为网卡添加地址 例如：ip addr add 192.168.1.100/24 dev eth0

![](https://via.placeholder.com/800x600?text=Image+b7579241beaec3db)

 

      del：删除网卡上指定的IP地址，格式同上

![](https://via.placeholder.com/800x600?text=Image+53198a23c8f2b2ec)

 

      flush：清空所有IP地址（谨慎使用）                  例如ip addr flush dev eth0

![](https://via.placeholder.com/800x600?text=Image+4175e649ed23d528)
...
![](https://via.placeholder.com/800x600?text=Image+f9e1231394059498)

      add：添加路由    ip route add IP/MASK via next_hop  例如：ip route add 192.168.1.100 via 192.168.2.1

![](https://via.placeholder.com/800x600?text=Image+978bceaad806a648)

      del：删除路由    ip route del IP/MASK

![](https://via.placeholder.com/800x600?text=Image+471d53c1298dc340)
...
![](https://via.placeholder.com/800x600?text=Image+f40ec6a16adfe9ec)
...
![](https://via.placeholder.com/800x600?text=Image+ff3fdfc588645f3a)
...
![](https://via.placeholder.com/800x600?text=Image+383f5ef2ab97a5c6)
