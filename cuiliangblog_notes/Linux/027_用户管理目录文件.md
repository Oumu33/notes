...
> 来源: Linux
> 创建时间: 2021-02-16T09:18:03+08:00
> 更新时间: 2026-01-11T09:32:26.754632+08:00
> 阅读量: 749 | 点赞: 0
...
![](https://via.placeholder.com/800x600?text=Image+78d07ca47ed534ef)

1. 超级用户：/root/，所有者和所属组都是root用户，权限是550

![](https://via.placeholder.com/800x600?text=Image+c0e3e08f88a1245d)

# 二、用户的邮箱
1. /var/spool/mail/用户名

![](https://via.placeholder.com/800x600?text=Image+463eda29d756798a)
...
![](https://via.placeholder.com/800x600?text=Image+993aef15d7dc5368)

1. 当我们用useradd      或adduser命令添加新用户时，linux系统会自动复制/etc/skel下的所有文件(包括隐藏文件)到新添加用户的家目录

![](https://via.placeholder.com/800x600?text=Image+80340bcbbbd9661e)
...
![](https://via.placeholder.com/800x600?text=Image+8af6de83b0c13ff4)
