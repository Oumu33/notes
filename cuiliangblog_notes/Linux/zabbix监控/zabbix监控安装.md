...
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465229519-6190ac07-e736-496f-818c-ebb0e60a0bcf.png)
    1. 可以看到，zabbix自动检查了安装环境是否满足要求，如果出现不满足要求的情况，需要进一步处理，此处没有问题，点击下一步
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465229943-dece167d-05bd-4d21-8dbc-7eee1207de19.png)
    1. 此处zabbix需要配置数据库连接，此处配置数据库的类型，IP，端口，数据库名，用户密码等信息，端口填写0表示使用默认端口（3306端口）
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465230263-a2e4e469-cd5e-42d4-89c8-57ce3db8b407.png)
    1. 此处填写zabbix server的详细信息，包括IP地址，端口号，以及server名称等，填写完成后点击下一步。
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465230858-222f4b64-20dd-4956-a4fd-7475a8d148e2.png)
    1. 在配置之前，请确定概要信息无误，点击下一步。
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465235382-19ed5aa3-0d91-4260-a561-52a7b3ef82b6.png)
...
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465235800-3e73866a-634a-41be-b0ff-782d8d7e636a.png)
    1. 点击完成按钮后，可以看到zabbix的登录页面，默认的管理员用户为admin，密码为zabbix，输入用户名密码后登录。
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465234836-dc6d8063-2953-494c-b0cb-112a7fee166c.png)
    1. 登录完成后，可以看到zabbix的仪表盘。
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465237767-a3a7512f-b042-44f1-bc17-f5239713e098.png)
    1. 默认是英文显示，需要可以调成中文，点击下图中红框标注的图标。
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465238113-4d39bd51-d88d-44dc-8b94-9400354744d4.png)
    1. 语言选择中文，点击更新即可，上述操作完成后，zabbix控制台即显示为中文了。
+ 为了更加安全，我们不应该使用管理员的默认密码，所以，我们最好先修改管理员密码
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465239074-fdff52df-1c95-4125-9dd0-dfed8db755e6.png)
    1. 以后的监控工作就要围绕这个web界面展开了，为了以后更好的展开工作，先大概的了解一下zabbix的菜单。
+ 管理菜单中，一般用于管理zabbix自身及zabbix相关设置。
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465243243-a4a13737-9eb6-4856-94fd-adf57d135e9f.png)
+ 配置菜单中，一般用于配置监控相关设置
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465238233-9028c01a-cec4-4c90-8c5c-d2f41a3e463d.png)
+ 监测中菜单，一般用于查看被监控的相关数据
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465237680-a8d7f16d-0de4-44d7-9e53-271b7ed9336e.png)
+ 报表菜单中，可以为管理员生成一段时间内的监控统计信息。
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465238463-00ed9136-c494-43f7-9692-7c05a070bb68.png)
+ 资产记录菜单中，管理员可以查看被管控的主机有哪些，以及相关的资产信息。
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465236782-94b559b0-3731-4836-8481-f5be23cc0286.png)
...
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465238197-8b2bbc20-4ce3-4b03-909b-fec41f66e9a2.png)
+  
+ ![](https://cdn.nlark.com/yuque/0/2021/png/2308212/1613465238998-78e3ce40-9210-4200-be62-0788ca92bbbf.png)
