...
> 来源: Web
> 创建时间: 2021-02-19T15:49:44+08:00
> 更新时间: 2026-01-11T09:22:06.786010+08:00
> 阅读量: 673 | 点赞: 0
...
| _Root |   |   |
| ---: | --- | --- |
| ![](https://via.placeholder.com/800x600?text=Image+c52ea6b51d31a7dc) | cn | 存放中文HTML文件 |
| ![](https://via.placeholder.com/800x600?text=Image+c52ea6b51d31a7dc) | en | 存放英文HTML文件 |
| ![](https://via.placeholder.com/800x600?text=Image+c52ea6b51d31a7dc) | flash | 存放Flash文件 |
| ![](https://via.placeholder.com/800x600?text=Image+c52ea6b51d31a7dc) | images | 存放图片文件 |
| ![](https://via.placeholder.com/800x600?text=Image+c52ea6b51d31a7dc) | imagestudio | 存放PSD源文件 |
| ![](https://via.placeholder.com/800x600?text=Image+c52ea6b51d31a7dc) | flashstudio | 存放flash源文件 |
| ![](https://via.placeholder.com/800x600?text=Image+c52ea6b51d31a7dc) | inc | 存放include文件 |
| ![](https://via.placeholder.com/800x600?text=Image+c52ea6b51d31a7dc) | library | 存放DW库文件 |
| ![](https://via.placeholder.com/800x600?text=Image+c52ea6b51d31a7dc) | media | 存放多媒体文件 |
| ![](https://via.placeholder.com/800x600?text=Image+c52ea6b51d31a7dc) | project | 存放工程项目资料 |
| ![](https://via.placeholder.com/800x600?text=Image+c52ea6b51d31a7dc) | temp | 存放客户原始资料 |
| ![](https://via.placeholder.com/800x600?text=Image+c52ea6b51d31a7dc) | js | 存放JavaScript脚本 |
| ![](https://via.placeholder.com/800x600?text=Image+c52ea6b51d31a7dc) | css | 存放CSS文件 |
...
![](https://via.placeholder.com/800x600?text=Image+0dca03100c72d15e) 
...
![](https://via.placeholder.com/800x600?text=Image+114b7889f2f8c1e2)
...
![](https://via.placeholder.com/800x600?text=Image+4a6f790ba9f9599b)
