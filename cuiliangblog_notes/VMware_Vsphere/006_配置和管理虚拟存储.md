...
> 来源: VMware Vsphere
> 创建时间: 2021-02-16T17:23:13+08:00
> 更新时间: 2026-01-11T09:01:23.407175+08:00
> 阅读量: 894 | 点赞: 0
...
# 二、vmware存储
    1. vmware支持的存储类型
+ ![](https://via.placeholder.com/800x600?text=Image+4d76ac68ae98b688)
    1. 存储协议
+ ![](https://via.placeholder.com/800x600?text=Image+f38d553b121e223f)
    1. 数据存储类型
+ ![](https://via.placeholder.com/800x600?text=Image+bde32d3ab3a5d3dc)
    1. RDM裸设备映射（写入数据不经过vmfs封装，性能好，不可迁移）
+ ![](https://via.placeholder.com/800x600?text=Image+91be14a26395b81a)
    1. 虚拟机添加RDM盘
+ ![](https://via.placeholder.com/800x600?text=Image+557fd5fdf08035f0)
    1. 光纤fc-san
+ ![](https://via.placeholder.com/800x600?text=Image+2632700bbf223399)
    1. 光纤通道多路径（冗余）
+ ![](https://via.placeholder.com/800x600?text=Image+21509ccfb4d6e844)
    1. FCoE适配器（ipsan、fcsan共存组网情况使用）
+ ![](https://via.placeholder.com/800x600?text=Image+630d1e6aece8bae4)
    1. ip-san
+ ![](https://via.placeholder.com/800x600?text=Image+7de293d5770d1449)
    1. iscsi适配器
+ ![](https://via.placeholder.com/800x600?text=Image+1326803be0e2e9bd)
    1. ip-san网络配置
+ ![](https://via.placeholder.com/800x600?text=Image+bd27c94f261ea8fd)
    1. 创建与发现iscsi服务
+ ![](https://via.placeholder.com/800x600?text=Image+9f72efbc2e75187a)
    1. nfs
+ ![](https://via.placeholder.com/800x600?text=Image+39f8cff8e5021c61)

# 三、vsan
    1. 架构
+ ![](https://via.placeholder.com/800x600?text=Image+6edd32fe19992bb5)
    1. 磁盘组
+ ![](https://via.placeholder.com/800x600?text=Image+e0c6763f8237ddd4)
...
+ ![](https://via.placeholder.com/800x600?text=Image+258de61b7ebd7cfd)
    2. 选择新建的存储适配器——目标——动态发现——添加
+ ![](https://via.placeholder.com/800x600?text=Image+3ee627eafda6480b)
    2. 重新扫描存储适配器
+ ![](https://via.placeholder.com/800x600?text=Image+64715d0e4d381039)
    2. 添加数据存储
+ ![](https://via.placeholder.com/800x600?text=Image+e540932bc93ea161)
    2. 选择磁盘格式vmfs——设备名称——分区
+ ![](https://via.placeholder.com/800x600?text=Image+faa1b4fb336f7723)
...
+ ![](https://via.placeholder.com/800x600?text=Image+bd3bf0c102d5dc60)
    1. 光纤通道SAN中的端口
...
+ ![](https://via.placeholder.com/800x600?text=Image+f0d935d83a9eb94c)
    1. FCoE适配器
...
+ ![](https://via.placeholder.com/800x600?text=Image+5ef72a0efa631766)
    1. 硬件FCoE适配器
...
+ ![](https://via.placeholder.com/800x600?text=Image+532a89db2c542614)
    1. 光纤通道的多路径功能
...
+ 到另一条路径的过程称为路径故障切换。
+ ![](https://via.placeholder.com/800x600?text=Image+61634fed0c85d399)
...
+ ![](https://via.placeholder.com/800x600?text=Image+a5cf9775e8862aee)
...
+ ![](https://via.placeholder.com/800x600?text=Image+41f332408be509ce)
    1. 打开"主机和群集"视图，选择一个主机
+ ![](https://via.placeholder.com/800x600?text=Image+3a39de6aad131cd5)
    1. 右击主机，选中"存储"，点击'新建数据存储'
+ ![](https://via.placeholder.com/800x600?text=Image+d68e18078efe3a86)
    1. 新建数据存储，创建VMFS数据存储
+ ![](https://via.placeholder.com/800x600?text=Image+2c74ebdcfbe89dcd)
    1. 指定数据存储名称（建议使用有意义的名称，清晰的数据存储命名可以方面管理员确定虚拟机位置，利于快速修复出现的问题）。
+ 选择要使用的LUN，每一个可见的LUN都会显示名称和标识符信息。
+ ![](https://via.placeholder.com/800x600?text=Image+7cea9026a4fcd8b0)
    1. 指定VMFS版本
+ ![](https://via.placeholder.com/800x600?text=Image+fd81dd8954d176ed)
    1. 指定分区配置：
...
+ ![](https://via.placeholder.com/800x600?text=Image+a85adcda6161771d)
    1. 在'即将完成"页面，检查数据存储配置信息，然后单击完成。
+ ![](https://via.placeholder.com/800x600?text=Image+eb9e3944c68cd2d1)
...
# 十一、增加VMFS数据存储的容量
    ...
    - 添加数据区(LUN)O
    - 在数据区范围内扩展数据存储。
+ ![](https://via.placeholder.com/800x600?text=Image+902aa9672c6327a9)
+  
