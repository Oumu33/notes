...
> 来源: Docker
> 创建时间: 2020-12-31T10:43:03+08:00
> 更新时间: 2026-01-11T09:29:36.233742+08:00
> 阅读量: 737 | 点赞: 0
...
![](https://via.placeholder.com/800x600?text=Image+d549f0fe1066e96a)
...
![](https://via.placeholder.com/800x600?text=Image+72d26b8af988eac0)
...
![](https://via.placeholder.com/800x600?text=Image+b70f381961ef1282)
...
![](https://via.placeholder.com/800x600?text=Image+b29e38888dc7a6f4)

![](https://via.placeholder.com/800x600?text=Image+157b71637a65bbdf)

+ 运行容器，使用docker1网络

[root@docker ~]# docker run -it --network docker1 busybox

![](https://via.placeholder.com/800x600?text=Image+a6fd264f22fdfd6a)

+ 运行容器，指定ip地址

[root@docker ~]# docker run -it --network docker1 --ip 192.168.0.100 busybox

![](https://via.placeholder.com/800x600?text=Image+febd667fc0049ac6)
...
![](https://via.placeholder.com/800x600?text=Image+18c4c069d01789a5)

+ 容器中增加了一个网卡 eth1，分配了docker1 的 IP 192.168.0.3。使用busybox访问测试

![](https://via.placeholder.com/800x600?text=Image+8549d90ad13d2ecc)
...
![](https://via.placeholder.com/800x600?text=Image+878d796ed81de50a)
...
![](https://via.placeholder.com/800x600?text=Image+80f1d34c208ed8ef)
...
![](https://via.placeholder.com/800x600?text=Image+359a0ad74f6a9d2c)
...
![](https://via.placeholder.com/800x600?text=Image+19a5c1ad4f55041e)

+ node2主机查看网络

![](https://via.placeholder.com/800x600?text=Image+a1799d156400286d)

![](https://via.placeholder.com/800x600?text=Image+61e9104bb41feb7f)
...
![](https://via.placeholder.com/800x600?text=Image+a55f9a140d5988f3)

+ 运行容器后会在宿主机上生成一个overlay网桥

![](https://via.placeholder.com/800x600?text=Image+99974d5ab4ebbc43)
...
![](https://via.placeholder.com/800x600?text=Image+128d7713eb163b04)

+ bbox2访问bbox1

![](https://via.placeholder.com/800x600?text=Image+052d2b54d16f06d3)
...
![](https://via.placeholder.com/800x600?text=Image+76be2e5db7a5b5d5)
...
![](https://via.placeholder.com/800x600?text=Image+6d094b75111591a7)

![](https://via.placeholder.com/800x600?text=Image+178b08fa2cbfe98f)

+ 测试与bbox1、bbox2网络连通性

![](https://via.placeholder.com/800x600?text=Image+7101795ecfe6ba4d)

+ 网络拓扑

![](https://via.placeholder.com/800x600?text=Image+b18be2c790ccade0)
