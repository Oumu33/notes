...
> 来源: Docker
> 创建时间: 2020-12-31T12:18:38+08:00
> 更新时间: 2026-01-11T09:29:47.084676+08:00
> 阅读量: 775 | 点赞: 0
...
![](https://via.placeholder.com/800x600?text=Image+62898f483f858c41)

+ 新建一个centos容器，执行sleep命令，查看docker进程

[root@docker ~]# docker run --name test -d centos sleep 9999

![](https://via.placeholder.com/800x600?text=Image+02a049231382f0d8)

每当启动一个容器后，相应的会启动一个containerd-shim进程进程号为1859，作为该容器内所有进程的根进程

+ 查看容器内部进程信息

![](https://via.placeholder.com/800x600?text=Image+0fe2cac7b53590a1)

+ 宿主机与容器内进程关系空间如果所示

![](https://via.placeholder.com/800x600?text=Image+60b873a86c125fe6)
...
![](https://via.placeholder.com/800x600?text=Image+9ae381f8fec19f86)

+ 使用docker network      ls命令可以查看到当前系统中的网桥：

![](https://via.placeholder.com/800x600?text=Image+ca83f1e2f4748d88)
...
![](https://via.placeholder.com/800x600?text=Image+b1669ee616664dfc)
...
![](https://via.placeholder.com/800x600?text=Image+ea60be17e109be2a)
...
![](https://via.placeholder.com/800x600?text=Image+888544639bc7be1a)

![](https://via.placeholder.com/800x600?text=Image+9b4c0054abb6494e)

+ 例如，下面的命令在容器内创建了test用户，只有普通权限，无法访问更高权限的资源：

![](https://via.placeholder.com/800x600?text=Image+316075c701dff295)
