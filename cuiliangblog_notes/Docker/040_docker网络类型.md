...
> 来源: Docker
> 创建时间: 2020-12-31T11:13:33+08:00
> 更新时间: 2026-01-11T09:29:34.842712+08:00
> 阅读量: 732 | 点赞: 0
...
![](https://via.placeholder.com/800x600?text=Image+c7472bae40a37738)
...
![](https://via.placeholder.com/800x600?text=Image+0c8bf14adf669bc5)
...
![](https://via.placeholder.com/800x600?text=Image+151bbc296fec3783)

# 三、bridge网络
+ Docker 安装时会创建一个命名为       docker0 的 linux bridge。如果不指定--network，创建的容器默认都会挂到 docker0 上。
+ 创建一个容器后，查看容器网络信息。

![](https://via.placeholder.com/800x600?text=Image+d8005b46bddc956b)

![](https://via.placeholder.com/800x600?text=Image+70b6221f21c09112)

+ 查看服务器网络信息

![](https://via.placeholder.com/800x600?text=Image+1c754dd2d380f395)
...
![](https://via.placeholder.com/800x600?text=Image+16cdef4aa37bdef7)
