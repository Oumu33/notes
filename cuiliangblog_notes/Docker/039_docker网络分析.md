...
> 来源: Docker
> 创建时间: 2020-12-31T11:16:38+08:00
> 更新时间: 2026-01-11T09:29:32.155767+08:00
> 阅读量: 796 | 点赞: 0
...
![](https://via.placeholder.com/800x600?text=Image+d0d0e96e62b15c45)
...
![](https://via.placeholder.com/800x600?text=Image+79941550330ec992)

+ 除了映射动态端口，也可在 -p 中指定映射到 host      某个特定端口，例如可将 80 端口映射到 host 的 8080 端口：

![](https://via.placeholder.com/800x600?text=Image+d0abe6538eade0b2)

3. 每一个映射的端口，host 都会启动一个      docker-proxy 进程来处理访问容器的流量：

![](https://via.placeholder.com/800x600?text=Image+15e9177b163a6373)

4. 以 0.0.0.0:32770->80/tcp      为例分析整个过程：

![](https://via.placeholder.com/800x600?text=Image+aa853d9a84f8b2bf)
