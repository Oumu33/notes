...
> 来源: Kubernetes
> 创建时间: 2020-11-01T13:48:03+08:00
> 更新时间: 2026-01-11T09:10:12.212863+08:00
> 阅读量: 962 | 点赞: 0
...
![](https://via.placeholder.com/800x600?text=Image+41c8ae15980986a3)

+ 创建测试正常pod  
`kubectl run limit-pod1 --image=ikubernetes/myapp:v1 --restart=Never` 
+ 查看pod默认信息

![](https://via.placeholder.com/800x600?text=Image+6d8583b34784ace7)

+ 创建pod对象设定的系统资源需求量大于LimitRange中的最大用量限制  
`kubectl run limit-pod2 --image=ikubernetes/myapp:v1 --restart=Never --limits='cpu=3000m'` 

![](https://via.placeholder.com/800x600?text=Image+48967f32b29f62fb)
...
![](https://via.placeholder.com/800x600?text=Image+72897db45ffb5620)

+ describe命令打印其限额的生效情况

![](https://via.placeholder.com/800x600?text=Image+e3413fd56ad96591)

+ 创建一个pod后查看信息  
`kubectl run limit-pod1 --image=ikubernetes/myapp:v1 --restart=Never`

![](https://via.placeholder.com/800x600?text=Image+53f121393a243a4a) 
