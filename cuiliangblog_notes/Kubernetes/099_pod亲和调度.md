...
> 来源: Kubernetes
> 创建时间: 2020-11-01T14:18:09+08:00
> 更新时间: 2026-01-11T09:10:32.674476+08:00
> 阅读量: 998 | 点赞: 0
...
![](https://via.placeholder.com/800x600?text=Image+17181f977642ab6e)

+ 查看pod信息，与“app=tomcat”的Deployment资源在同一node上

![](https://via.placeholder.com/800x600?text=Image+44dbd0f5998185a9)

2. pod软亲和调度
+ 定义Pod对象，通过labelSelector定义的标签选择器，尽可能使其调度到和app=apache的资源到同一个主机名的节点上。（当前环境不存在app=apache的资源）

![](https://via.placeholder.com/800x600?text=Image+3c2b8f210d6cb498)

+ myapp被调度到了node1和node2节点上

![](https://via.placeholder.com/800x600?text=Image+b7e6ac4c7e709100)
...
![](https://via.placeholder.com/800x600?text=Image+89f4cc5b572013b3)

+ myapp被调度到了node1节点上

![](https://via.placeholder.com/800x600?text=Image+cf8a59c1bd5fcf1b)
