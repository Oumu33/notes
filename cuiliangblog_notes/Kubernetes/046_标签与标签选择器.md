...
> 来源: Kubernetes
> 创建时间: 2020-10-31T14:33:10+08:00
> 更新时间: 2026-01-11T09:05:42.782471+08:00
> 阅读量: 1090 | 点赞: 0
...
![](https://via.placeholder.com/800x600?text=Image+21ab199b9c69e425)

2. 在“kubectl get pods”命令中使用“--show-labels”选项，以额外显示对象的标签信息：  
$ kubectl get pods --show-labels

![](https://via.placeholder.com/800x600?text=Image+779df25c1e1d9965)

3. 按需进行添加标签操作。  
$ kubectl label pods/pod-with-labels version=v1

![](https://via.placeholder.com/800x600?text=Image+38b8df4fde64d6e1)

4. 对于已经附带了指定键名的标签，使用“--overwrite”命令以强制覆盖原有的键值  
$ kubectl label pods/pod-with-labels version=v2 --overwrite

![](https://via.placeholder.com/800x600?text=Image+a2e22bef3eeea72f)

5. 删除指定键名的标签，使用“标签名-”，即可删除

![](https://via.placeholder.com/800x600?text=Image+1319b3fb7fcf661a)
...
![](https://via.placeholder.com/800x600?text=Image+794dc3f8d69da601)
...
![](https://via.placeholder.com/800x600?text=Image+401dfebb37bb2672)
